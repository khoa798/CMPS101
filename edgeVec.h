/* edgeVec.h
 * Header file for edgeVec, to show ADT functions
 and declare all classes of functions of ADT's: constructors, manipulation, access
 */
...
/** edgeTop()
 * Preconditions: myVec != NULL, myVec has been constructed
 */
